      ...
      purchase_units: [
        {
          ...
          amount: {
            ...
            breakdown: {
              ...
              handling: { currency_code: config.PAYPAL_CURRENCY, value: (order.packaging_fee || 0).toFixed(2) },
              tax_total: { currency_code: config.PAYPAL_CURRENCY, value: (order.order_fee || 0).toFixed(2) },
